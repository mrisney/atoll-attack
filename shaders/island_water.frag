...
uniform float u_island_radius;  // <-- ADD THIS LINE
...
void main() {
    ...
    float islandRadius = u_island_radius; // <-- USE THE UNIFORM
    ...
    // Color bands with multiple shades of blue for shallow water
    vec3 deepWater = vec3(0.13, 0.52, 0.77);    // #2185C5 - deep blue
    vec3 shallowWater = vec3(0.29, 0.67, 0.91); // #4AB0E9 - lighter blue
    vec3 shallows = vec3(0.53, 0.82, 0.98);     // #87D1FA - lightest blue
