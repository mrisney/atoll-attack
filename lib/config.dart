...
final Vector2 kBlueSpawnLocation =
    Vector2(200, 100); // Blue team spawns at north
...
// Flag raising settings
const double kFlagRaiseDuration =
    5.0; // Time in seconds to raise the flag to full height
const double kFlagRaiseRange =
    8.0; // Distance from apex where captain can start raising flag
const bool kFlagRaiseRequiresStationary =
    true; // Captain must be stationary to raise flag
const double kFlagRaiseStationaryThreshold =
    1.0; // Maximum velocity to be considered stationary
